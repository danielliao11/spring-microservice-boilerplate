...
public class SignTest {
  ...
  public void testSign() throws Exception {
    ...
    //then
    assertThat(param.isSignValid(PUBLIC_KEY)).isTrue();
    assertThat(sign).isEqualTo(decodeSign);
  }
  ...
  public void testOppSign() throws Exception {
    ...
    //when
    boolean signValid = param.isSignValid(OPP_KEY);

    //then
    assertThat(signValid).isTrue();
  }
